...
import com.agilerules.iotled.model.AmsProcessProto.AmsProcess;
import com.agilerules.iotled.model.AmsSyncAckProto.AmsSyncAck;
import com.agilerules.iotled.model.DeviceConnect.DeviceConnectProto;
import com.agilerules.iotled.model.RunRequestProto.RunRequest;
import com.agilerules.iotled.model.SyncRequestProto.SyncRequest;
...
//			AmsProcessDetails amsProcessDetails = AmsProcessDetails.newBuilder().setPid(1)
//					.setProductName("Product1").setIsActive(true).setModified(1).setTitle("AMS1003-PROCESS")
//					.setUpdatedOn(new Timestamp(1552188612000L).toString()).build();
			amsProcess.setClientId(Long.parseLong(asyncClient.getClientId()));
//			AmsProcessDetails amsProcessDetails2 = AmsProcessDetails.newBuilder().setPid(2)
//					.setProductName("Product2").setIsActive(true).setModified(1).setTitle("AMS1001-PROCESS")
//					.setUpdatedOn(new Timestamp(1552188612000L).toString()).build();
//			amsProcess.addAmsProcessDetails(amsProcessDetails);
//			amsProcess.addAmsProcessDetails(amsProcessDetails2);
